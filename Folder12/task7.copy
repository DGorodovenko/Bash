...
#użycie set w taki sposób pozwala na to, że kolejne operacje beda wywolane na 
kolejnych wartościach $1, $2 itd...
set $CIAG
...
#shift pozwala na zamienienie argumentu -> wartosc argumentu $2 przechodzi na $1 
itd...
